...
class GRPCPrefetchCall(jina_pb2_grpc.JinaRPCServicer):
    ...
    def __init__(self, args, zmqlet=None, grpclet=None):
        super().__init__()
        self._servicer = PrefetchCaller(args, zmqlet=zmqlet, grpclet=grpclet)
...
class GRPCRuntime(AsyncNewLoopRuntime):
    ...
    async def async_setup(self):
        ...
        if self.args.grpc_data_requests:
            ...
            self._prefetcher = GRPCPrefetchCall(self.args, zmqlet=self.zmqlet)
